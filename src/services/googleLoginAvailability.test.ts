...
assert.deepEqual(
    ...
    }),
    {
        ...
        note: "Desktop Google login needs a Google Cloud OAuth client of type Desktop app. Set VITE_GOOGLE_DESKTOP_CLIENT_ID and VITE_GOOGLE_DESKTOP_CLIENT_SECRET, then restart the app.",
    },
);
